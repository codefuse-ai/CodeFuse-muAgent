...
class Role(BaseModel):
    ...
    role_prompt: str = ""
    prompt: str = "" # full prompt include role\task\input\output prompt

    output_template: str = ""
    session_context_level: int = 1 # 0~2： dont use\exist only when it has\always exist whenever is has  
    task_context_level: int = 0 # 0~2： dont use\exist only when it has\always exist whenever is has  
    react_context_level: int = 0 # 0~2： dont use\exist only when it has\always exist whenever is has  
    search_doc_level: int = 1 # 0~2： dont use\exist only when it has\always exist whenever is has  
    doc_doc_level: int = 1 # 0~2： dont use\exist only when it has\always exist whenever is has   
    code_doc_level: int = 1 # 0~2： dont use\exist only when it has\always exist whenever is has  
    tool_level: int = 1 # 0~1： dont use\exist only when it has
    agent_level: int = 1 # 0~1： dont use\exist only when it has
