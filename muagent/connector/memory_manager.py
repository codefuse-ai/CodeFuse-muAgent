...
from muagent.utils.common_utils import save_to_json_file, read_json_file, addMinutesToTime
...
class LocalMemoryManager(BaseMemoryManager):
    ...
    def append(self, message: Message) -> None:
        ...
        if (message.datetime not in datetimes) or ((message.input_query not in contents) and (message.role_content not in contents)):
