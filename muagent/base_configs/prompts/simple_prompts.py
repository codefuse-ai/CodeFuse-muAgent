...
{"nodes":{"节点序号":{"type":"节点类型","content":"节点内容"},}}
...
{"edges":[{"start":"起始节点序号","end":"终止节点序号"}]}
edges 用来存放节点间的连接顺序，它是一个列表，每个元素是一个字典，包含 start 和 end 两个属性， start 为起始 node 的 节点序号, end 为结束 node 的 节点序号。

3. 生成表示流程图的完整json: 将上面[确定流程图节点]和[连接流程图节点]步骤中的结果放到一个json，检查生成的流程图是否符合给定输入文本的内容，优化流程图的结构，合并相邻同类型节点，返回最终的json。注意返回的json内容要紧凑，不要包含额外的空格和换行符。
#############
# 风格 #
...
# 响应 #
返回json结构定义如下:
{"nodes":{"节点序号":{"type":"节点类型","content":"节点内容"}},"edges":[{"start":"起始节点序号","end":"终止节点序号"}]}
#############
# 例子 #
以下是几个例子：
...
输出:{"nodes":{"0":{"type":"Schedule","content":"排查网络问题"},"1":{"type":"Task","content":"查询sofagw网关监控BOLT失败数"},"2":{"type":"Task","content":"查询sofagw网关监控退保成功率"},"3":{"type":"Task","content":"判断两条时序相关性"},"4":{"type":"Phenomenon","content":"相关性较高"},"5":{"type":"Analysis","content":"网络问题"}},"edges":[{"start":"0","end":"1"},{"start":"1","end":"2"},{"start":"2","end":"3"},{"start":"3","end":"4"},{"start":"4","end":"5"}]}
...
输出:{"nodes":{"0":{"type":"Schedule","content":"使用模版创建选品集"},"1":{"type":"Task","content":"创建选品集\n\n注：因为只能选择同类型模版，必须先选择数据类型，才能选择模版创建"},"2":{"type":"Task","content":"按需选择模版后，点击确认\n\n - 我的收藏：个人选择收藏的模版 \n\n - 我的创建：个人创建的模版 \n\n - 模版广场：公开的模版，可以通过名称/创建人搜索到需要的模版并选择使用"},"3":{"type":"Task","content":"按需调整指标模版内的值，完成选品集创建"}},"edges":[{"start":"0","end":"1"},{"start":"1","end":"2"},{"start":"2","end":"3"}]}
...
输出:{"nodes":{"0":{"type":"Schedule","content":"场景权限申请"},"1":{"type":"Task","content":"点击右侧的左右切换箭头，找到自己所在的站点或业务模块"},"2":{"type":"Task","content":"查询对应一级场景，若没有所需一级场景则联系 [@小明][@小红]添加：具体操作如下：\n 发送邮件给小明和小红，抄送小白，邮件内容包括项目背景，场景名称，场景描述，数据类型和业务管理员"},"3":{"type": "Task","content":"查询对应二级场景，若没有所需二级场景则联系一级场景管理员添加，支持通过搜索二级场景名称和ID快速查询二级场景"},"4":{"type":"Task","content": "申请二级场景数据权限，由对应二级场景管理员审批。若二级场景管理员为@小花@小映，按一级场景走申请流程"}},"edges":[{"start":"0","end":"1"},{"start":"1","end":"2"},{"start":"2","end":"3"},{"start":"3","end":"4"}]}
