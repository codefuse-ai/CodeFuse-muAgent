...
from muagent.connector.memory import HierarchicalMemoryManager
...
gb_config = GBConfig(vb_type="HierarchicalMemoryManager")
hierach_memory_manager = HierarchicalMemoryManager(embed_config=embed_config, llm_config=llm_config, vb_config=vb_config, gb_config=gb_config, do_init=True)
# append can ignore user_name
hierach_memory_manager.append(message=message1)
hierach_memory_manager.append(message=message2)
hierach_memory_manager.append(message=message3)
