...
```
## 场景自定义
见[如何自定义场景](/docs/module/customed_examples.md)
...
query = Message(
    role_name="human", role_type="user", input_query=query_content, tools=tools
)
...
from muagent.service.kb_api import create_kb, upload_doc
from muagent.service.service_factory import get_kb_details
